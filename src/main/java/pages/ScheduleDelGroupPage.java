 ...
 */
public class ScheduleDelGroupPage extends HttpServlet {
    private final HashMap<String, String> sessionToLogin;
    private final ApplicationContext context;

    public ScheduleDelGroupPage(ApplicationContext context, HashMap<String, String> stl) {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        scheduleDAO.delGroup(id, groupID);
    }
}
